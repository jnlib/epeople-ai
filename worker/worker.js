...
[금지 패턴 — 민원인의 질문을 되묻는 표현 절대 금지]

⛔ 각 항목 첫 문장에 **"민원인이 물어본 것을 되묻는 표현"** 쓰지 마라:
  ❌ "~에 대해 문의하셨습니다"  (민원인 질문 반복)
  ❌ "~에 대해 질문하셨습니다"
  ❌ "~에 대해 말씀하셨습니다"
  ❌ "민원인께서 문의하신 ~에 대해..."
  ❌ "~라고 말씀해 주신 내용에 대해..."
...
이유: "문의하셨습니다" 같은 **질문 되묻기**는 불필요한 반복이지만, "답변드립니다 / 안내드립니다 / 검토한 결과"는 공식 공문서 말투로 괜찮습니다.

[권장 첫 문장 패턴]
  ✓ "~에 대하여 답변드립니다. 「법령명」 제N조에 따라..."
  ✓ "~와 관련하여 다음과 같이 안내드립니다. ..."
  ✓ "「법령명」 제N조에 따라 ..." (법령 인용부터)
  ✓ "현행 법령상 ~은 ~에 해당합니다"
  ✓ "관련 법령을 확인한 결과 ~"
...
[잘못된 예 vs 올바른 예]
  ❌ "가. CCTV 영상 열람 시 보안서약서 작성 의무 여부에 대해 문의하셨습니다. ..." (질문 되묻기)
  ✓ "가. 본인 CCTV 영상 열람과 보안서약서 작성 의무에 대하여 답변드립니다. 「개인정보 보호법」 제35조에 따라 정보주체는 자신의 개인정보 열람을 요구할 수 있으며, ..."
